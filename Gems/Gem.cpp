...
void Gem::SetSelected() { 
	// функция для установки выделения гема при нажатии (делает цвет прозрачнее)
...
void Gem::SetDeselected() {
	// функция для снятия выделения гема, возвращает исходный цвет гему
...
sf::Color Gem::ChoiceColor() {
	// функция для выбора цвета гема при его создании
